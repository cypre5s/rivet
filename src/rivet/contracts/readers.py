...
class ReaderRequest(ContractModel):
    ...
    timeout_seconds: int = Field(default=30, gt=0, le=3_600)
    ...
    max_image_pixels: int = Field(default=40_000_000, gt=0, le=100_000_000)
    max_video_frames: int = Field(default=20, ge=0, le=20)
    max_audio_duration: int = Field(default=14_400, gt=0, le=86_400)
